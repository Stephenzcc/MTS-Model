...
parser.add_argument('--selected_dataset', default='ACSF1', type=str,
...
torch.backends.cudnn.deterministic = True  # 保证复现性
torch.backends.cudnn.benchmark = True  # find最优算法，不保证最快
np.random.seed(SEED)
#####################################################
